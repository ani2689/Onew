...
public class Onew extends Thread{
            ...
            try {
                ...
                if(hp<=30){
                    switch ((int)(Math.random()*5)){
                        case 0:
                            MessageBox.messageText = onewName+"(이)가 죽을 지경이에요!";
                            break;
                        case 1:
                            MessageBox.messageText ="어서 밥을 주세요!";
                            break;
                        case 2:
                            MessageBox.messageText = onewName+"(이)는 지금 배가 고프다는데...";
                            break;
                        case 3:
                    ...
                    switch ((int)(Math.random()*5)){
                        case 0:
                            MessageBox.messageText = onewName+"(이)가 배가 고프다며 투정을 부려요.";
                            break;
                        case 1:
                            MessageBox.messageText ="이런! 창고가 비었나요?";
                            break;
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            MessageBox.messageText =onewName+"(이)는 열심히 운동하고 있어요!";
                            break;
                    }
                }else if(full<=50){
                    switch ((int)(Math.random()*5)){
                    case 0:
                        MessageBox.messageText = onewName+"(이)는 지금 기분이 좋아요.";
                        break;
                    case 1:
                    ...
                    switch ((int)(Math.random()*5)) {
                        case 0:
                            ...
                            break;
                        case 1:
                            MessageBox.messageText = onewName+"(이)는 지금 충분히 베가 불러요";
                            break;
                        case 2:
                            MessageBox.messageText = "꾸준히 먹어야 튼튼해져요.";
                            break;
                        case 3:
                            ...
                            break;
                        case 4:
                            MessageBox.messageText = onewName+", 아무래도 좋아보여요.";
                            break;
                    }
                }else{
                    switch ((int)(Math.random()*5)) {
                        case 0:
                            ...
                            break;
                        case 1:
                            MessageBox.messageText = onewName+"(이)는 행복하답니다.";
                            break;
                        case 2:
                            MessageBox.messageText = "꾸준히 먹어야 튼튼해져요.";
                            break;
    ...
    public String getOnewName() {
        return onewName;
    }

    public void setOnewName(String onewName) {
